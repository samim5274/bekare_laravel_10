        ...
        <div class="pc-content">
            ...
            <div class="container mt-4">
                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                    ...
                    <form action="{{url('/search-date-purchase-order')}}" method="GET" class="bg-white border rounded p-3 mb-4 w-100">
                        @csrf
                    ...
                    <table class="table table-bordered table-striped " id="printableTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('/view-delivery-item/'.$val->chalan_reg)}}">CH-{{$val->chalan_reg}}</a></td>
                                <td>৳{{$val->total}}/-</td>
                                <td>
                                    @switch($val->status)
                                        @case(1)
