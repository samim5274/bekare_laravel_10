            ...
            <div class="container mt-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <h5 class="m-0 text-primary">
                        <a href="{{url('/print-all-due-order-date-wise')}}" target="_blank"><i class="fa-solid fa-print"></i> Print </a>
                    </h5>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-md-12 grid-margin stretch-card">
                        <div class="card mt-2">
                            <div class="card-body p-2 p-md-4">
                                <form action="{{url('/search-report-date-wise-due-sale-report')}}" method="POST" target="_blank">
                                    @CSRF
                                    <div class="row">
                                        <div class="col-lg-4">
