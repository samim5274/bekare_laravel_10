                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4 allData">
                            <div class="card h-100 shadow-sm">
                                <a href="#"><img src="{{ asset('/img/food/' . $val->image) }}" class="card-img-top" alt="image not found" style="max-height: 250px;"></a>
                                <div class="card-body d-flex flex-column">
                                    <h4 class="card-title"><a href="#">{{strlen($val->name) > 22 ? substr($val->name, 0, 22).'...' : $val->name}} - ৳{{ $val->price }}/-</a></h4>
